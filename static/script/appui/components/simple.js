...
require.def("sudoku/appui/components/simple",
    [
        ...
        return Component.extend({
            init: function () {
                ...
                carouselButton.addEventListener("select", function(evt){
                    self.getCurrentApplication().pushComponent("maincontainer", "sudoku/appui/components/simplecarouselcomponent");
                });
                ...
                playerButton.addEventListener("select", function(evt){
                    self.getCurrentApplication().pushComponent("maincontainer", "sudoku/appui/components/simplevideocomponent");
                });
