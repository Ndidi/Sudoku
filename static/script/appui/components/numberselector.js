...
//                var newGameBtn = new Button("newGame");
//                newGameBtn.appendChildWidget(new Label("New Game"));
//                newGameBtn.addClass("numberSelectorButton");
//                list.appendChildWidget(newGameBtn);
